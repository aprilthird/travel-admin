...
class _BannerPageState extends State<BannerPage> {
  ...
  Future<Null> _getData() async {
    ...
    if (_lastVisible == null)
      ...
      data = await firestore
          .collection(collectionName)
          .orderBy('timestamp', descending: true)
          .startAfter([_lastVisible['timestamp']]).get();
  ...
  handlePreview(Banners d) async {
    await showBannerPreview(context, d.title, d.description,
        d.thumbnailImagelUrl, d.sourceUrl, d.date);
  }
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          ...
          children: <Widget>[
            ...
            Text(
              'Quiere borrar este archivo de la base de datos?',
              style: TextStyle(
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      if (ab.userType == 'tester') {
                        ...
                        await ab
                            .deleteContent(timestamp, 'banner')
