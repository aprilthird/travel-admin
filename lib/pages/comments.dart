...
class _CommentsPageState extends State<CommentsPage> {
                    ...
                    onPressed: () async {
                      if (ab.userType == 'tester') {
                        ...
                        openDialog(context, 'Eres un Tester',
                            'Solo los admin pueden borrar comentarios');
                      } else {
                        await context
                            .read<CommentBloc>()
                          ...
                          if (widget.collectionName == 'places') {
                            context
                                ...
                                context, 'Comentario eliminado exitosamente'));
                        reloadData();
                        Navigator.pop(context);
                      }
                    },
  ...
  handleSubmit(value) async {
    ...
    if (ab.userType == 'tester') {
      openDialog(
          context, 'Eres un Tester', 'Solo los admin pueden hacer comentarios');
    } else {
      if (value.isEmpty) {
        ...
        await context
          ...
          if (widget.collectionName == 'places') {
            context
                ...
                openToast(context, 'Comentario añadido exitosamente!'));
        clearTextFields();
        reloadData();
      }
    }
