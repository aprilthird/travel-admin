  ...
  handleAddState() async {
    ...
    if (formKey.currentState.validate()) {
      ...
      if (ab.userType == 'tester') {
        Navigator.pop(context);
        openDialog(context, 'Eres un Tester',
            'Solo los admin pueden agregar contenido');
      } else {
        await getTimestamp()
            .then((value) => addState())
            .then((value) =>
    ...
    showDialog(
        ...
        builder: (context) {
          return SimpleDialog(
            ...
            children: <Widget>[
              Text(
                'Añadir Estado/Divisón a la base de datos',
              ...
              Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        decoration: inputDecoration('Ingrese nombre del estado',
                            'Nombre del estado', nameCtrl),
                        controller: nameCtrl,
                        validator: (value) {
                          if (value.isEmpty)
                            return 'El nombre del estado está vacío';
                          return null;
                        },
                      ),
                      SizedBox(
